...
module.exports = class Agent {
    ...
    getOfferOrder(offer) {
        const himOffer = this.minus(this.counts, offer);
        const myCount = this.getCountGoods(offer);
        const maxPrices = this.maxGoodsPrices(offer);
        const myValue = this.product(offer);
        const himCount = this.totalCount - myCount;
        const heWantAll = myCount === 0;
