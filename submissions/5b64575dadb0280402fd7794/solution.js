...
class Analytics {
    ...
    aggressiveOffer() {
        ...
        if (calculateProfit(offer, this.values) > 0) {
            return offer;
        }
...
module.exports = class Agent {
    ...
    offer(o) {
        ...
        if (o) {
            ...
            const aggressiveOffer = this.analytics.aggressiveOffer();
            ...
            if (opponentTotal >= this.total * CONFIG.autoApplyOffers) {
                this.log('agree if opponent get all valuable objects');
                return;
            }
            ...
            if (this.meFirst) {
                ...
                if (this._isLastRound()) {
                    ...
                    this.log('disagree. your offer is offended for my script');
                    return [...this.bestOffer];
                }
                ...
                if (this.rounds === 1) {
                    ...
                    if (this.bestOpponentOfferTotal > 0 && this.bestOpponentOfferTotal >= this.total * 0.4) {
                        this.log('agree on opponent best offer (pre last round)');
                        return this.bestOpponentOffer;
                    }
                }
                ...
                if (!this._isLastRound() && currentTotal < this.bestOpponentOfferTotal) {
                    if (this.bestOpponentOfferTotal >= this.total * CONFIG.goodOpponentOffer) {
                        this.log('agree on opponent best offer');
                        return this.bestOpponentOffer;
                    }
